...
public class CommentController extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) 
		...
		else if(commandStr.equals("/commnetDelete.comm")) {
	...
	private void commentWrite(HttpServletRequest req, HttpServletResponse resp)
		...
		/*
		 Servlet에서 기능처리를 위한 메소드는 doGet, doPost와 동일하게
		 request, response객체를 매개변수로 사용하고,
		 ServletException. IOException에 대한 예외처리를 해주는게 좋다.
		 */
		...
		if(result==1)
			/*
			 댓글 장석 완료 후 내용보기 페이지로 리다이렉트 할 때 
