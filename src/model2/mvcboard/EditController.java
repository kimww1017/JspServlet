...
public class EditController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		//물리적경로와 제한용량을 통해 MultipartRequest 객체 생성 및 파일 업로드
		...
		if(mr!=null) {
			...
			/*
			 Servlet에서 getSession()메소드를 통해 session내장객체를 얻어온 후
			...
			/*
			 디렉토리의 물리적 경로가 잘못되었거나, 파일용량이 초과되었을 때에는
			 MultipartRequest객체가 생성되지 않는다.
			 즉, 글쓰기 오류가 발생하게 된다. 
			 */
