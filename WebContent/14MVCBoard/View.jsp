	...
	<tr>
		<td colspan="4" align="center">
			<!-- 
			 ...
			 진행해야 한다.
			 따라서, 동일한 요청명으로 진입하는 대신 파라미터를 통해
			 수정, 삭제를 구분하여 분기한다.
			 -->
			<button type="button" 
...
function commentDelete(idx, board_idx){
	window.open('./commenDelete.comm?idx='+idx+'&board_idx='+board_idx, 'commentPop','top=0, left=0, width=700, height=300');
}
</script>
<!-- 
	HTML에서 지원하는 앵커(Ancher)기능으로 해당 페이지에서 특정 위치를
	로드하고 싶을 때 아래와 같이 <a태그에 name속성을 부여한다.
