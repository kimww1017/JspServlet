...
<!-- 
 수정 페이지에서도 파일을 첨부할 수 있으므로 enctype이 있어야 한다.
 만약 파일을 첨부하지 않은 상태로 수정을 하게되면, 기존의 파일명을
 그대로 유지해야 하므로 hidden입력상자를 통해 기존 파일명을 
 전송한다.
 -->
<form name="writeFrm" method="post" enctype="multipart/form-data"
	 action="../mvcboard/edit.do" onsubmit="return formValidate(this);">
<input type="hid den" name="idx" value="${dto.idx }"><!-- 일련번호 -->	 
<input type="hid den" name="prevOfile" value="${dto.ofile }"><!-- 원본파일명 -->
<input type="hid den" name="prevSfile" value="${dto.sfile }"><!-- 서버에 저장된 파일명 -->
